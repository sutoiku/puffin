...
This first gathering will set the benchmark for all future events — participants will receive a highly collectible *"I was there"* [lapel pin](https://en.wikipedia.org/wiki/Eraserhead).
