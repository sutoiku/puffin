...
## Do I really need Spark for Iceberg?
Initially, yes. But [Icecap](docs/Icecap.md) will soon provide a Spark-less implementation of [Iceberg tables](https://iceberg.apache.org/spec/).
...
Of course. There are many ways to do that. One of them is to use any Python package that embeds [DuckDB](https://duckdb.org/), such as [duckdb - PyPi](https://pypi.org/project/duckdb/), then install the PuffinDB extension through the SQL API. The same mechanism will be used to add support for PuffinDB from [Ibis](https://ibis-project.org/), thereby giving Ibis access to [Apache Iceberg](https://iceberg.apache.org/), [Apache Hudi](https://hudi.apache.org/), and [Delta Lake](https://delta.io/) tables.
