...
[Amazon Athena](https://aws.amazon.com/athena/) can be used to read | write any [Iceberg tables](https://iceberg.apache.org/spec/), but many read queries will be faster and more cost-effective when using [DuckDB](https://duckdb.org/).
