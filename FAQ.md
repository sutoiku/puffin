...
Initially, PuffinDB will be deployed on [AWS Lambda](https://aws.amazon.com/lambda/) functions and a single [Amazon EC2](https://aws.amazon.com/ec2/) instance. Support for [AWS Fargate](https://aws.amazon.com/fargate/) will be added later on.
