...
[Spark SQL](https://spark.apache.org/sql/) can be use to read | write any [Iceberg tables](https://iceberg.apache.org/docs/latest/configuration/), but many read queries will be much faster and much more cost-effective when using [DuckDB](https://duckdb.org/).
