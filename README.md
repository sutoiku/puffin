...
- Built-in low-latency table scanning API (fetch table partitions from filter predicates) running on standalone function (without [Apache Spark](https://spark.apache.org/))
