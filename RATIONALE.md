...
By definition, OLAP (online analytical processing) engines are designed to work on immutable data, and are used downstream of OLTP (online transaction processing) system.
